...
from ultralytics.nn.modules.parameternet import DynamicConv,DynamicBnAct


from ultralytics.nn.modules.block import DownLTSPD
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            MSFM,
            RFAConv,
            DynamicConv,DynamicBnAct, CoordConv,
            MSFA, DownLT, DownLTSPD,
        }:
            c1, c2 = ch[f], args[0]
