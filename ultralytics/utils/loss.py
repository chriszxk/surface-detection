...
from .metrics import bbox_iou, probiou, bbox_SDIoU
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        iou = bbox_SDIoU(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, SDIoU=True, d=0.6)
        # iou = bbox_inner_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, CIoU=True, ratio=0.5)
